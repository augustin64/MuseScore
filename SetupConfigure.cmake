...
# framework
def_opt(MUSE_MODULE_ACCESSIBILITY ${MUSE_MODULE_ACCESSIBILITY} OFF)
def_opt(MUSE_MODULE_AUDIO ${MUSE_MODULE_AUDIO} OFF)
def_opt(MUSE_MODULE_AUDIO_EXPORT ${MUSE_MODULE_AUDIO_EXPORT} OFF)
def_opt(MUSE_MODULE_AUDIOPLUGINS ${MUSE_MODULE_AUDIOPLUGINS} OFF)
def_opt(MUSE_MODULE_AUTOBOT ${MUSE_MODULE_AUTOBOT} OFF)
def_opt(MUSE_MODULE_CLOUD ${MUSE_MODULE_CLOUD} OFF)
def_opt(MUSE_MODULE_DRAW ${MUSE_MODULE_DRAW} OFF)
def_opt(MUSE_MODULE_DIAGNOSTICS ${MUSE_MODULE_DIAGNOSTICS} OFF)
def_opt(MUSE_MODULE_EXTENSIONS ${MUSE_MODULE_EXTENSIONS} OFF)
def_opt(MUSE_MODULE_LANGUAGES ${MUSE_MODULE_LANGUAGES} OFF)
def_opt(MUSE_MODULE_LEARN ${MUSE_MODULE_LEARN} OFF)
def_opt(MUSE_MODULE_MIDI ${MUSE_MODULE_MIDI} OFF)
def_opt(MUSE_MODULE_MPE ${MUSE_MODULE_MPE} OFF)
def_opt(MUSE_MODULE_MULTIINSTANCES ${MUSE_MODULE_MULTIINSTANCES} OFF)
def_opt(MUSE_MODULE_MUSESAMPLER ${MUSE_MODULE_MUSESAMPLER} OFF)
def_opt(MUSE_MODULE_NETWORK ${MUSE_MODULE_NETWORK} OFF)
def_opt(MUSE_MODULE_SHORTCUTS ${MUSE_MODULE_SHORTCUTS} OFF)
def_opt(MUSE_MODULE_TOURS ${MUSE_MODULE_TOURS} OFF)
def_opt(MUSE_MODULE_UI ${MUSE_MODULE_UI} OFF)
def_opt(MUSE_MODULE_UPDATE ${MUSE_MODULE_UPDATE} OFF)
def_opt(MUSE_MODULE_VST ${MUSE_MODULE_VST} OFF)
def_opt(MUSE_MODULE_WORKSPACE ${MUSE_MODULE_WORKSPACE} OFF)
# modules
...
# import/export
def_opt(MUE_BUILD_IMPEXP_BB_MODULE, ${MUE_BUILD_IMPEXP_BB_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_BWW_MODULE, ${MUE_BUILD_IMPEXP_BWW_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_CAPELLA_MODULE, ${MUE_BUILD_IMPEXP_CAPELLA_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_MIDI_MODULE, ${MUE_BUILD_IMPEXP_MIDI_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_MUSEDATA_MODULE, ${MUE_BUILD_IMPEXP_MUSEDATA_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_MUSICXML_MODULE, ${MUE_BUILD_IMPEXP_MUSICXML_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_OVE_MODULE, ${MUE_BUILD_IMPEXP_OVE_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_AUDIOEXPORT_MODULE, ${MUE_BUILD_IMPEXP_AUDIOEXPORT_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_IMAGESEXPORT_MODULE, ${MUE_BUILD_IMPEXP_IMAGESEXPORT_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_GUITARPRO_MODULE, ${MUE_BUILD_IMPEXP_GUITARPRO_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_MEI_MODULE, ${MUE_BUILD_IMPEXP_MEI_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_VIDEOEXPORT_MODULE, ${MUE_BUILD_IMPEXP_VIDEOEXPORT_MODULE} OFF)
def_opt(MUE_BUILD_IMPEXP_TABLEDIT_MODULE, ${MUE_BUILD_IMPEXP_TABLEDIT_MODULE} OFF)
