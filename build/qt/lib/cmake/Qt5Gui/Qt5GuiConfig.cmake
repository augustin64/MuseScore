...
if (NOT TARGET Qt5::Gui)
    ...
    set_property(TARGET Qt5::Gui PROPERTY INTERFACE_QT_ENABLED_FEATURES accessibility;action;opengles2;clipboard;colornames;cssparser;cursor;desktopservices;imageformat_xpm;draganddrop;opengl;imageformatplugin;highdpiscaling;im;image_heuristic_mask;image_text;imageformat_bmp;imageformat_jpeg;imageformat_png;imageformat_ppm;imageformat_xbm;movie;opengles3;pdf;picture;sessionmanager;shortcut;standarditemmodel;systemtrayicon;tabletevent;texthtmlparser;textmarkdownreader;textmarkdownwriter;textodfwriter;validator;whatsthis;wheelevent)
    set_property(TARGET Qt5::Gui PROPERTY INTERFACE_QT_DISABLED_FEATURES angle;combined-angle-lib;dynamicgl;opengles31;opengles32;openvg;system-textmarkdownreader;vulkan)
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 angle;combined-angle-lib;dynamicgl;opengles31;opengles32;openvg;system-textmarkdownreader;vulkan)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 egl;freetype;gif;harfbuzz;ico;imageio-text-loading;jpeg;multiprocess;png;raster-64bit;tuiotouch;vkgen)
    set_property(TARGET Qt5::Gui
    ...
    # endif()
    file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5Gui_QOffscreenIntegrationPlugin.cmake")
